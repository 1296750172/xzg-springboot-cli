...
public class MybatisPlusGenerater {
    static String url ="jdbc:mysql://127.0.0.1:3306/xzg-admin?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai";
    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create(url, username, password)
                ...
                .packageConfig(builder -> {
                    builder.parent("cn.happain.system") // 设置父包名
                            .moduleName("permissionModule") // 设置父包模块名
                            .entity("model")
                            .service("service")
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("xzg_permission") // 设置需要生成的表名
                            .addTablePrefix("xzg");
                })
